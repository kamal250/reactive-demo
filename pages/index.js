    ...
    <div className={styles.container}>
      ...
      <section className="px-4 py-8 bg-gray-50">
        <table className="w-full bg-white rounded shadow table-auto">
            ...
            <tr>
              <th className="py-6 pl-6">
                <a className="flex items-center text-xs text-gray-500" href="#">
                  <p>Name</p>
                  <svg className="w-2 h-3 ml-1" width="9" height="12" viewBox="0 0 9 12" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <tbody>
            <tr className="text-xs border-b border-gray-100 bg-blue-50">
              <td className="py-6 pl-6 bg-blue-100">Ashton Cox</td>
              <td className="pl-6">Technical Author</td>
              <td>San Francisco</td>
            </tr>
            <tr className="text-xs border-b border-gray-100">
              <td className="py-6 pl-6 bg-blue-50">Cedric Kelly</td>
              <td className="pl-6">Javascript Developer</td>
              <td>Edinburgh</td>
            </tr>
            <tr className="text-xs border-b border-gray-100 bg-blue-50">
              <td className="py-6 pl-6 bg-blue-100">Garrett Winters</td>
              <td className="pl-6">Director</td>
              <td>San Francisco</td>
            </tr>
            <tr className="text-xs">
              <td className="py-6 pl-6 bg-blue-50">Tiger Nixon</td>
